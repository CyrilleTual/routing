...
const dataCloud = [
    {
        ...
        "text":
        [
            "Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe excepturi nobis deleniti soluta, fugiat recusandae laboriosam possimus necessitatibus deserunt, id odit eius commodi, est asperiores corporis ea animi quo quasi..","Lorem ipsum dolor sit amet consectetur adipisicing elit.Facilis qui ipsum maxime architecto illum nam.",
            null,
...
const dataSolution = [
    ...
    {
        "icon":true,"title":"sauvegarde","text":["Lorem ipsum dolor sit amet consectetur adipisicing elit Facilis qui ipsum maxime architecto illum nam."]
    }
]

const dataShared = [{"icon":false,"price":"9,99","text":["Lorem ipsum dolor sit amet consectetur adipisicing elit.Facilis qui ipsum maxime architecto illum nam.","Lorem ipsum dolor sit amet consectetur adipisicing elit.Facilis qui ipsum maxime architecto illum nam.","Lorem ipsum dolor sit, amet consectetur adipisicing elit. Labore neque rerum soluta at corrupti consectetur doloribus, earum aut explicabo libero incidunt velit nesciunt dolore optio iste accusantium cupiditate est atque. Quae voluptatem exercitationem eligendi similique reprehenderit aliquid perspiciatis delectus! Porro ipsa esse quibusdam nobis eos suscipit molestias possimus dicta atque!"]}]

const dataDedicated = [{"icon":false,"price":"19,99","text":["Lorem ipsum dolor sit, amet consectetur adipisicing elit. Natus, recusandae ad quo et delectus accusamus.","Lorem ipsum dolor sit amet consectetur adipisicing elit.Facilis qui ipsum maxime architecto illum nam.","Lorem ipsum dolor sit, amet consectetur adipisicing elit. Labore neque rerum soluta at corrupti consectetur doloribus, earum aut explicabo libero incidunt velit nesciunt dolore optio iste accusantium cupiditate est atque. Quae voluptatem exercitationem eligendi similique reprehenderit aliquid perspiciatis delectus! Porro ipsa esse quibusdam nobis eos suscipit molestias possimus dicta atque!","Lorem ipsum dolor sit amet consectetur, adipisicing elit. Atque dolorum ipsum unde eos minima! Est illum alias inventore, architecto hic accusamus. Culpa magnam dolore itaque."]}]

export {dataHosting, dataSolution, dataCloud, dataShared, dataDedicated}